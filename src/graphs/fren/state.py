...
# PROMPTS
############################################################################
SYSTEM_PROMPT = """You are a smart and clever online agent.

The chat application has commands for the user - ONLY if they ask what they can do, tell them to type `/help`
"""
# fkn pepe...
